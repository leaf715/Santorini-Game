...
class Santorini:
    ...
    def main(self):
        ...
        while len(players) != n_next:
            ...
            new_default_player.name = "bot" + str(bot_num)
            bot_num = bot_num + 1
        ...
        if mode == '-league':
            ...
            self.league_scoreboard(scoreboard)
    ...
    def league_scoreboard(self, scores):
        scoreboard_list = [(v, k) for k, v in scores.iteritems()]
